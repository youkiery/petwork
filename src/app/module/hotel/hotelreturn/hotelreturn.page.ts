...
@Component({
  selector: 'app-hotelreturn',
  templateUrl: './hotelreturn.page.html',
  styleUrls: ['./hotelreturn.page.scss'],
})
export class HotelreturnPage {
  public count = 0
  public max = 1024
  ...
  public async return( ) {
    ...
    this.rest.checkpost('hotel', 'returning', this.rest.temp).then(resp => {
      this.rest.defreeze()
