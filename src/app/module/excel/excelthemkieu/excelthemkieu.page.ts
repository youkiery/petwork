...
@Component({
  selector: 'app-excelthemkieu',
  templateUrl: './excelthemkieu.page.html',
  styleUrls: ['./excelthemkieu.page.scss'],
})
export class ExcelthemkieuPage implements OnInit {
  public max = 960
  public count = 0
  ...
  public async them() {
      ...
      this.rest.checkpost('spa', 'themkieu', this.rest.temp).then(resp => {
        this.rest.defreeze()
        this.rest.back()
      }, () => {
        this.rest.defreeze()
  ...
  public async uploadAllImage() {
    return new Promise((resolve) => {
      let hinhanh = [this.rest.temp.image]
      let count = hinhanh.length
