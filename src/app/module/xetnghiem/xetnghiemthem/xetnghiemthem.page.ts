...
export class XetnghiemthemPage implements OnInit {
  ...
  //   this.rest.checkpost('xetnghiem', 'insert', this.rest.temp).then(resp => {
  //     this.rest.defreeze()
  //     if (!this.rest.temp.his) {
  //       this.rest.xetnghiem.segment = '1'
  //       this.rest.xetnghiem.s = '2'
  //       this.rest.xetnghiem.need = resp.need
  //       this.rest.xetnghiem.list = resp.list
  //     }
  //     this.rest.xetnghiem.serial = resp.serial
  ...
  // public async updatexetnghiem() {
  //   await this.rest.freeze('Đang tải dữ liệu...')
  //   await this.uploadAllImage()
  //   this.rest.checkpost('xetnghiem', 'updatexetnghiem', this.rest.temp).then(resp => {
  //     this.rest.defreeze()
  //     this.rest.xetnghiem.segment = '1'
  //     this.rest.xetnghiem.s = '2'
  //     this.rest.xetnghiem.list = resp.list
  ...
  //   await this.rest.freeze('Đang tải dữ liệu...')
  //   this.rest.checkpost('xetnghiem', 'insertselect', {
  //     typename: type,
  //     typevalue: typevalue,
  //   }).then(resp => {
  //     this.rest.defreeze()
  //     this.rest.xetnghiem[type] = resp.list
  //     this.rest.temp[type] = this.rest.xetnghiem[type][this.rest.xetnghiem[type].length - 1].id
  //   }, () => {
  //     this.rest.defreeze()
  //   })
  // }
