...
@Component({
  selector: 'app-hisschedule',
  templateUrl: './hisschedule.page.html',
  styleUrls: ['./hisschedule.page.scss'],
})
export class HisschedulePage {
  public max = 960
  public count = 0
  ...
  public async schedule( ) {
    ...
    this.rest.checkpost('his', 'schedule', this.rest.temp).then(resp => {
      this.rest.defreeze()
