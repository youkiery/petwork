...
@Component({
  selector: 'app-datlichchuyenmon',
  templateUrl: './datlichchuyenmon.page.html',
  styleUrls: ['./datlichchuyenmon.page.scss'],
})
export class DatlichchuyenmonPage implements OnInit {
  ...
  ionViewWillEnter() {
    ...
    else if (!this.rest.chuyenmon.khoitao) this.khoitao()
  }
