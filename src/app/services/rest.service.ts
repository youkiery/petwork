...
export class RestService {
  ...
  public spa = { time: 0, init: false, datlichhomnay: [], list: [], near: [], filter: [], old: [], keyword: '', keyword2: '', toggle: false, style: [], search: {status: 0, start: '', end: ''}, thongke: {dauthang: '', cuoithang: ''}, khoitaothongke: false, dulieu: [] }
  ...
  public xetnghiem = { khoitao: false, danhsach: [], danhsachcan: [], danhsachchitieu: [], dulieuchitieu: [], chitieugiong: [], tab: "2", timkiem: { tukhoa: "", batdau: "", ketthuc: "", loai: 0 } }
  ...
  public khachhang = { khoitao: false, thongke: [], tukhoa: "", tungay: "", denngay: "", danhsach: [], khoitaochuyenmon: false, chuyenmon: [], nhanvien: [], dichvu: [], danhgia: [], thoigian: "", khoitaochinhanh: false, chinhanh: [] }
  ...
  public congviec = { khoitao: false, modanhmuc: {}, danhsach: [], timkiem: { batdau: "", ketthuc: "", nhanvien: "0", tukhoa: '', danhmuc: '', denhan: 0, hoanthanh: 0 }, chedo: '0', danhmuc: [], childid: -1, child: [], nhanvien: [], khoitaolaplai: false, danhsachlaplai: [] }
  ...
  public nhantin = { khoitaonhantin: false, danhsachnhantin: [], khoitaoloaitru: false, danhsachloaitru: [], cauhinhnhantin: { min: 0, max: 0, mautin: [], danhsachloai: [] }, bodem: { thanhcong: 0, thatbai: 0, batdau: 0, tieptheo: 0, dagui: 0, tongcong: 0, min: 0, max: 0, tile: 0, thutu: 0, dautien: true }, demgio: null, hengio: null, danggui: false, dangguitin: false, hoanthanh: false, khoitaothongke: false, thongke: { tile: 0, tongkhongden: 0, loainhan: [0, 0, 0, 0], quaylai: [0, 0, 0, 0], tongnhan: 0, tongkhach: 0, danhsachden: [], danhsachkhongden: [], nhomnhantin: [] }, batdau: '', ketthuc: '', chonngay: [], thoigian: '' }
  ...
  public dienso(so: any) {
    if (Number(so) < 10) return "0" + so.toString()
    return so
  }
