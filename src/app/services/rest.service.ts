...
export class RestService {
  ...
  public nhantin = { khoitaonhantin: false, danhsachnhantin: [], khoitaoloaitru: false, danhsachloaitru: [], cauhinhnhantin: { min: 0, max: 0, mautin: [], danhsachloai: [] }, bodem: { thanhcong: 0, thatbai: 0, batdau: 0, tieptheo: 0, dagui: 0, tongcong: 0, min: 0, max: 0, tile: 0, thutu: 0, dautien: true }, demgio: null, hengio: null, danggui: false, dangguitin: false, hoanthanh: false, khoitaothongke: false, thongke: { loainhan: [0, 0, 0, 0], quaylai: [0, 0, 0, 0], tongnhan: 0, tongkhach: 0, danhsachden: [], danhsachkhongden: [], nhomnhantin: [] }, batdau: '', ketthuc: '', chonngay: [], thoigian: '' }
